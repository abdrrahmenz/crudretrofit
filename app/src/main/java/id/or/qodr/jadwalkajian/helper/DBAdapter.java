...
//    }
                    ...
                    String lng,String cp)
    {
        try
        {
            ...
            values.put(JadwalModel.KEY_ID, _id); // jenis_kajian
    ...
    public Cursor retrieveKajianHari(String date) {
        ...
        if (date !=null && date.length() >0) {
            String sql = "SELECT * FROM " + JadwalModel.TABLE_USER + " WHERE " + JadwalModel.KEY_DATE + " LIKE '%" + date + "%'";
            c = db.rawQuery(sql, null);
            return c;
        }
        c = db.query(JadwalModel.TABLE_USER,column,null,null,null,null,null);
        return c;
    }
